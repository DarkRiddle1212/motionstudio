...
class SubmissionService {
    async createSubmission(data, studentId) {
    ...
    async getSubmissionsByAssignment(assignmentId, userId, userRole) {
    ...
    async getStudentSubmissions(studentId, userId, userRole) {
