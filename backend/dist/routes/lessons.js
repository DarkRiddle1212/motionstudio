...
router.get('/course/:courseId', auth_1.authenticateToken, (0, auth_1.requireCourseEnrollment)('courseId'), async (req, res) => {
    try {
...
router.get('/:id', auth_1.authenticateToken, (0, auth_1.requireLessonAccess)(), async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/:id/complete', auth_1.authenticateToken, (0, auth_1.requireLessonAccess)(), async (req, res) => {
    try {
        const { id } = req.params;
...
router.get('/instructor/course/:courseId', auth_1.authenticateToken, (0, auth_1.requireRole)(['instructor', 'admin']), async (req, res) => {
    try {
        const { courseId } = req.params;
