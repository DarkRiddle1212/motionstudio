...
import { requireCourseEnrollment, AuthenticatedRequest } from '../auth';
      ...
      await fc.assert(
        fc.asyncProperty(
          ...
          async (courseData, userData) => {
            ...
            const validToken = generateToken(tokenPayload);
            ...
            const middleware = requireCourseEnrollment('courseId');
