...
export class FeedbackService {
  async createFeedback(data: CreateFeedbackData, instructorId: string) {
  ...
  async getFeedbackById(feedbackId: string, userId: string, userRole: string) {
  ...
  async getFeedbackBySubmission(submissionId: string, userId: string, userRole: string) {
  ...
  async updateFeedback(feedbackId: string, instructorId: string, data: UpdateFeedbackData) {
  ...
  async getStudentFeedback(studentId: string, userId: string, userRole: string) {
