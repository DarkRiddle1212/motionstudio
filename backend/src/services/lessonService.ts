...
export class LessonService {
  ...
  async getLessonsByCourse(courseId: string, studentId?: string, includeUnpublished = false) {
  ...
  async getLessonById(lessonId: string, studentId?: string, includeUnpublished = false) {
